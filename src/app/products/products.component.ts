...
export class ProductsComponent implements OnInit {
  ...
  addProduct(p: Product) {
    this.productService
      ...
      .catch(() => {
        this.snackBar.open("Error on submit the product.", "OK", {
          duration: 2000,
        });
      });
  }
  updateProduct(p: Product) {
    this.productService
      ...
      .catch(() => {
        this.snackBar.open("Error when updating to edit the product", "OK", {
          duration: 2000,
        });
      });
  }
  ...
  del(p: Product) {
    this.productService
      ...
      .catch(() => {
        this.snackBar.open("Error when trying to remove the product", "OK", {
          duration: 2000,
        });
      });
  }
